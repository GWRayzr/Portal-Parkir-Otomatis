...
def daftar (N, ID):                                    # Pendaftaran ID
# KAMUS
...
# Input & Proses
    ...
    return ID
def masuk (N, parkir_penuh, ID, plat, aktif, waktu):  # Simulasi Kendaraan Masuk
# KAMUS
...
def keluar (N,aktif,waktu,plat):                     # Simulasi Kendaraan Keluar
# KAMUS
  # ulang_keluar    :
  # kode_parkir     :
  # plat_no     
